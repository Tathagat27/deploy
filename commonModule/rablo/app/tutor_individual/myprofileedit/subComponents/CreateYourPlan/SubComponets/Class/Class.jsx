  ...
  return (
    <div className='Class_wrapper'>
        ...
        <div className='Section_6'>
            ...
            <div className={selectedSubjects.includes('SocialScience') ? 'Active_Subjects_Wrapper' : 'Subjects_Wrapper'} onClick={() => handleSubjectClick('SocialScience')}>Social Science</div>
            ...
            <div className={selectedSubjects.includes('ComputerScience') ? 'Active_Subjects_Wrapper' : 'Subjects_Wrapper'} onClick={() => handleSubjectClick('ComputerScience')}>ComputerScience</div>
            </div>
        </div>
