...
//Components
import Logout from "../Buttons_tutor/Logout/Logout";
    ...
    >
      ...
      <div className="hamburger">
        ...
        <div className="HamBurger_Icon">
          <Image src={Menu_Icon} alt="menu" style={{ width: "1.7vw" }} />
        </div>
      </div>
      ...
      <div className="Settings__Container">
        <div className="Free_point_card">
          {" "}
          <span style={{ marginBottom: "1.5vw", marginLeft: "1vw" }}>
            <FreePointsCard />
          </span>{" "}
        </div>
        <div className="Setting">
          {" "}
          <p className="Container_heading">Setting</p>
        </div>
        <div className="Link_Wrapper">
        ...
        <div className="Link_Wrapper">
          <div className="Logout_button">
            {" "}
            <Logout setModalShow={setModalShow} />{" "}
          </div>

          <div className="Logout_icon">
            {" "}
            <Image className="Icons" alt="logout" src={Logout_Icon} />{" "}
          </div>
        </div>
      </div>
      <LogoutPopup
