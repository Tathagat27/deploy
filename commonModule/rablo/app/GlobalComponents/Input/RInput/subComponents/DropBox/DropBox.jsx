...
const DropBox = () => {
  ...
  const [BrowseImage, setBrowseImage] = useState({
    selectedFile: null,
    fileName: "",
    uploading: true,
    loadingBar: 0,
          ...
          {BrowseImage.uploading ? (
            <div className="progress_bar">
              ...
              <div className="Loading_bar">
                <div>
                  <span style={{ width: `${BrowseImage.loadingBar}%` }}></span>
                </div>
            ...
            <div className="Image_after_uploaded_Wrapper">
              <div className="file_name">
                <Image
                  className="file_icon"
                  src={Document_Upload_Icon}
                  alt="document upload icon"
                />
                <p className="Uploaded_file_name">
                  {BrowseImage.fileName.slice(0, 4) +
                    BrowseImage.fileName.slice(-4)}
                </p>
                <IoClose
                  className="close"
                  onClick={() => {
