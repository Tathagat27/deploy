...
//Components
import Logout from "../Buttons_student/Logout/Logout";
import FreePointsCard from "./subComponents/FreePointsCard/FreePointsCard";
import LogoutPopUp from "../Popups_student/BoostrapModals/LogoutPopup/MyVerticallyCenteredModal";
...
import {
  setSideNavBarState,
  setShowModal,
} from "../../Redux/studentSlices/SideNavBar";
import PostNeed from "../Popups_student/PostYourNeed/PostNeed";
...
const SideNavBar = () => {
  ...
  return (
    <>
      <div
        onMouseOverCapture={openSidebar}
        onMouseOutCapture={Sliderbarclose}
      ...
      >
        ...
        <div className="hamburger">
          <div className="Close_Icons">
            <IoClose style={{ fontSize: "2.2vw", color: "white" }} />
          </div>
          <div className="HamBurger_Icon">
            <Image src={Menu_Icon} style={{ width: "1.7vw" }} />
          </div>
        </div>
        ...
        <div className="wrapper_div">
          <div className="DashBoard__Container">
            <div
              className={
                active == "Dashboard" ? "active Link_Wrapper" : "Link_Wrapper"
              }
            >
              {active == "Dashboard" && (
                <div
